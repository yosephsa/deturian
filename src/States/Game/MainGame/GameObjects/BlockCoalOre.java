 ...
 */
public class BlockCoalOre extends BlockObject{
	
	private static boolean hasNotLoaded = true;
	private static BufferedImage image;
	
	public BlockCoalOre(float x, float y, int s)
	{
		super(x, y, 1F, 1F, "BlockIronOre.png", false, s);
	}
	...
	@Override
	public void drawSelf(Graphics2D g, Camera c, int chunkNum)
	{
		drawBlock(g, c, chunkNum, image);
	}
}
