...
import musicplayer.jl.decoder.Bitstream;
import musicplayer.jl.decoder.BitstreamException;
import musicplayer.jl.decoder.Decoder;
import musicplayer.jl.decoder.Header;
import musicplayer.jl.decoder.JavaLayerException;
import musicplayer.jl.decoder.SampleBuffer;
import musicplayer.jl.player.AudioDevice;
import musicplayer.jl.player.FactoryRegistry;

/**
 * a hybrid of musicplayer.jl.player.Player tweeked to include <code>play(startFrame, endFrame)</code>
...
//				System.out.println(audio.getPosition());
	...
	{
		return new PlaybackEvent(this, id,Integer.MAX_VALUE - frame);
	}
