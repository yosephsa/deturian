 ...
 * 
 * 11/17/04	 Uncomplete frames discarded. E.B, javalayer@musicplayer.net 
 *
 * 12/05/03	 ID3v2 tag returned. E.B, javalayer@musicplayer.net 
 *
 * 12/12/99	 Based on Ibitstream. Exceptions thrown on errors,
 *			 Temporary removed seek functionality. mdm@techie.com
 *
 * 02/12/99 : Java Conversion by E.B , javalayer@musicplayer.net
 *
...
package musicplayer.jl.decoder;
...
import musicplayer.jl.decoder.BitstreamErrors;
