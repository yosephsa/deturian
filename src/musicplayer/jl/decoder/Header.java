 ...
 *            VBRI header support added, E.B javalayer@musicplayer.net
 * 
 * 12/04/03 : VBR (XING) header support added, E.B javalayer@musicplayer.net
 *
 * 02/13/99 : Java Conversion by music , E.B javalayer@musicplayer.net
 *
...
public final class Header
{
	 ...
	 * @param firstframe
	 * @author E.B (javalayer@musicplayer.net)
	 */
